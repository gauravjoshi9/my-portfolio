      ...
      <section id="contact" className="py-20 px-6 bg-slate-800/50">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex gap-6 justify-center mt-12 flex-wrap">
            <a href="mailto:youremail@gmail.com" className="text-slate-300 hover:text-blue-400 transition flex items-center gap-2">
              <Mail size={24} /> Email
            </a>
            <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-blue-400 transition flex items-center gap-2">
              <Github size={24} /> GitHub
            </a>
            <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-blue-400 transition flex items-center gap-2">
